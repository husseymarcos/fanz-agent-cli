...
describe("dates", () => {
  ...
  test("list dates for non-existent event throws", () => {
    const cli = session();
    loginAs(cli, "mock_viewer");
  ...
  test("create date dry-run does not mutate", () => {
    const cli = session();
    loginAs(cli, "mock_admin");
  ...
  test("create date for missing event throws", () => {
    const cli = session();
    loginAs(cli, "mock_admin");
  ...
  test("create date with invalid ISO throws", () => {
    const cli = session();
    loginAs(cli, "mock_admin");
  ...
  test("update date dry-run does not mutate", () => {
    const cli = session();
    loginAs(cli, "mock_admin");
  ...
  test("update non-existent date throws", () => {
    const cli = session();
    loginAs(cli, "mock_admin");
  ...
  test("delete date dry-run does not mutate", () => {
    const cli = session();
    loginAs(cli, "mock_admin");
    const before = cli.state.dates.length;
